import { Component, OnInit, ViewChildren, ElementRef, Injector } from '@angular/core';
...
export class EditarComponent extends FormBaseComponent implements OnInit {
  ...
  buscarCep(cep: string) {
    ...
    fornecedorService.consultarCep(cep)
      .subscribe({
  ...
  editarFornecedor() {
    if (this.fornecedorForm.dirty && this.fornecedorForm.valid) {
      ...
      const fornecedorService = this.injector.get(FornecedorService);
      fornecedorService.atualizarFornecedor(this.fornecedor)
        .subscribe({
  ...
  editarEndereco() {
    if (this.enderecoForm.dirty && this.enderecoForm.valid) {
      ...
      const fornecedorService = this.injector.get(FornecedorService);
      fornecedorService.atualizarEndereco(this.endereco)
        .subscribe({
